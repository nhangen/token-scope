...
- The hook now warns on **context size**, the thing that actually drives the bill: when one turn alone costs more than 0.5% of the cap, it reports the current context and what a further turn costs just to re-send it.
